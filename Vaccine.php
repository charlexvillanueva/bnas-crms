            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List of Vaccine</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $q=mysqli_query($con,"SELECT * FROM vvaccine Order by Fullname ASC");
      ...
      <form class="form-horizontal" id="frm">
                <div class="card-body">
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Vaccine Type</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="vacctype" name="vacctype">
                         </div>
                     </div>

                     <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">1st Dose</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="FistDose" name="FistDose">
                         </div>
                     </div>
                     <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Date 1st Dose</label>
                            <div class="col-sm-9">
                            <input type="date" class="form-control" id="DateFistDose" name="DateFistDose">
                         </div>
                     </div>
                     <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">2nd Dose</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="SecondDose" name="SecondDose">
                         </div>
                     </div>
                      <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Date 2nd Dose</label>
                            <div class="col-sm-9">
                            <input type="date" class="form-control" id="DateSecondDose" name="DateSecondDose">
                         </div>
                     </div>
                     <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Booster Shot</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="BoosterShot" name="BoosterShot">
                         </div>
                     </div>
                      <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Date Booster Shot</label>
                            <div class="col-sm-9">
                            <input type="date" class="form-control" id="DateBoosterShot" name="DateBoosterShot">
                         </div>
                     </div>
    ...
    $(document).ready(function(){
            ...
            $("#save").click(function(e){
             ...
             $('#delete').click(function(){
                ...
                if(selectedItems.length > 0){
                    $.ajax({
                        url: 'Actions/Vaccine/delete.php',
                        type: 'POST',
            ...
            $("#edit").click(function(e){
                ...
                if (checkedCount == 1) { 
                    ...
                    $.ajax({
                        method: 'GET',
                        url: "Actions/Vaccine/get.php?selectedItem=" + selectedItem,
                        dataType: 'json',
                        success: function(response){
                            $("#patient").val(response.Fullname);
                            $("#vacctype").val(response.vaccine_type);
                            $("#FistDose").val(response.First_Dose);
                            $("#DateFirstDose").val(response.Date_1st_Dose);
                            $("#SecondDose").val(response.Second_Dose);
                            $("#DateSecondDose").val(response.Date_2nd_Dose);
                            $("#BoosterShot").val(response.Booster_Shot);
                            $("#DateBoosterShot").val(response.Date_Booster_Shot);


                            $("#p_id").val(response.vid);
