            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List of Medicines </h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $q=mysqli_query($con,"SELECT medicines.mid,medicines.medDesc,medicines.qty,medicinecategory.medCat,medicines.dateacquired,medicines.expirydate FROM medicines INNER JOIN medicinecategory ON medicines.mcid=medicinecategory.mcid Order by medicines.medDesc ASC");
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="frm">
                ...
                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="Category" id="Category" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                ...
                <div class="form-group row">
                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Date Acquired</label>
                    <div class="col-sm-9">
    ...
    $(document).ready(function(){
            ...
            $("#save").click(function(e){
             ...
             $('#delete').click(function(){
                ...
                if(selectedItems.length > 0){
                    $.ajax({
                        url: 'Actions/Medicines/delete.php',
                        type: 'POST',
            ...
            $("#edit").click(function(e){
                ...
                if (checkedCount == 1) { 
                    ...
                    $.ajax({
                        method: 'GET',
                        url: "Actions/Medicines/get.php?selectedItem=" + selectedItem,
                        dataType: 'json',
                        success: function(response){
                            $("#Category").val(response.medCat);
                            $("#Description").val(response.medDesc);
                            $("#Quantity").val(response.qty);
                            $("#DateAcquired").val(response.DateAcquired);
                            $("#ExpiryDate").val(response.ExpiryDate);
                            
                            $("#p_id").val(response.mid);
