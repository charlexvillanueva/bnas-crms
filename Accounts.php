                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Settings </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="Account.php" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Accounts </span></a></li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $q=mysqli_query($con,"SELECT * FROM Accounts WHERE accType='User' Order by uname ASC");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal Account</h5>
...
<script>
    $(document).ready(function(){
            ...
            $("#add").click(function(){
                $("#exampleModalLabel").val("New Accounts")
                $("#frm")[0].reset();
            ...
            $("#edit").click(function(e){
                e.preventDefault();
                $("#exampleModalLabel").val("Update Account")
                ...
                if (checkedCount == 1) { 
                    ...
                    $.ajax({
                        method: 'GET',
                        url: "Actions/Accounts/get.php?selectedItem=" + selectedItem,
                        dataType: 'json',
                        success: function(response){
                            $("#username").val(response.uname);
                            $("#password").val(response.pword);
                            $("#p_id").val(response.uname);
