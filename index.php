...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="30x30" href="assets/images/favicon.png">
...
<body>
    ...
    <div id="main-wrapper">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="page-title"> CLINIC MANAGEMENT SYSTEM</h3>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Vaccine
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                <?php 
                                                    $q2=mysqli_query($con,"SELECT * FROM vaccine");
                                                    $rows2=mysqli_num_rows($q2);
                                                ?>
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $rows2; ?></div>
                                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                               User</div>
                                               <?php 
                                                    $q3=mysqli_query($con,"SELECT * FROM accounts");
                                                    $rows3=mysqli_num_rows($q3);
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $rows3; ?></div>
                                        </div>
                                        <div class="col-auto">
        ...
        <footer class="footer text-center">
                All Rights Reserved Clinic Management System.
            </footer>
        <!-- ============================================================== -->
        <!-- End Page wrapper  -->
        <!-- ============================================================== -->
