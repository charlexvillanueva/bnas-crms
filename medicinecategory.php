            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List of Medicine Category </h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $q=mysqli_query($con,"SELECT * FROM medicinecategory Order by medcat ASC");
                                                while ($rows=mysqli_fetch_array($q)) {
                                            ?>
                                            <tr>
                                                <td><input type="checkbox" name="item[]" value="<?php echo $rows[0]; ?>"></td>                                                <td><?php echo $rows[1]?></td>
                                            </tr>
                                            <?php
                                                 }
                                            ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="frm">
                <div class="card-body">
                <h4 class="card-title">Medicine Category Info</h4>
                <div class="form-group row">
                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Description</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="medcat" name="medcat">
                </div>
                </div>
               </div>
    ...
    $(document).ready(function(){
            ...
            $("#edit").click(function(e){
                ...
                if (checkedCount == 1) { 
                    ...
                    $.ajax({
                        method: 'GET',
                        url: "Actions/MedCat/get.php?selectedItem=" + selectedItem,
                        dataType: 'json',
                        success: function(response){
                            $("#medcat").val(response.medCat);
                            $("#p_id").val(response.mcid);
