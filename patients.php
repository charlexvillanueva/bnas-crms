            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Patients Record</h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" id="frm">
                ...
                <div class="form-group row">   
                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Birthday</label>
                <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="fname" class="col-sm-3 text-right control-label col-form-label">Blood Type</label>
                <div class="col-sm-9">
...
<script>
    $(document).ready(function(){
            ...
            $("#save").click(function(e){
             ...
             $('#delete').click(function(){
                ...
                if(selectedItems.length > 0){
                    $.ajax({
                        url: 'Actions/Patients/delete.php',
                        type: 'POST',
            ...
            $("#edit").click(function(e){
                ...
                if (checkedCount >= 2) {
                    alert("Two or more checkboxes are checked. Select 1 only!");
                    return;
                }
                if (checkedCount == 0) {
                ...
                if (checkedCount == 1) { 
                    ...
                    $.ajax({
                        method: 'GET',
                        url: "Actions/Patients/get.php?selectedItem=" + selectedItem,
                        dataType: 'json',
                        success: function(response){
